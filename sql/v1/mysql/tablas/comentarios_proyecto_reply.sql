...
-- fk_id_com_pro, Guarda el id del comentario padre
--
-- Defecto: Ninguno
--

CREATE TABLE comentarios_proyecto_reply (
    ...
    fk_id_com_pro BIGINT(20) NOT NULL,
	
	activo TINYINT(1) NOT NULL DEFAULT 1
);

ALTER TABLE comentarios_proyecto_reply
	ADD CONSTRAINT fk_comentarios_proyecto_reply_usuarios FOREIGN KEY (fk_id_usu) REFERENCES usuarios (id);
ALTER TABLE comentarios_proyecto_reply
	ADD CONSTRAINT fk_comentarios_proyecto_reply_proyectos FOREIGN KEY (fk_id_pro) REFERENCES proyectos (id);
ALTER TABLE comentarios_proyecto_reply 
    ADD CONSTRAINT fk_comentarios_proyecto_reply_comentarios FOREIGN KEY (fk_id_com_pro) REFERENCES comentarios_proyecto (id);
